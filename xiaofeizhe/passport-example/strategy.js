 ...
 * Module dependencies.
 */
var util = require('util'), OAuth2Strategy = require('passport-oauth').OAuth2Strategy, InternalOAuthError = require('passport-oauth').InternalOAuthError, parse = require('./profile').parse
...
Strategy.prototype.userProfile = function(accessToken, done) {
	...
	me._oauth2.get(pConf.protocol + '://' + pConf.host + pConf.profileUrl,
